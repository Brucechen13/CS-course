...
class TwoLayerNet(object):
  ...
  def loss(self, X, y=None, reg=0.0):
    ...
    shift_scores = c2 - np.max(c2, axis=1)[..., np.newaxis]
    ...
    loss /= N
    loss += reg * np.sum(W1 * W1) + reg * np.sum(W2 * W2)+ reg * np.sum(b1*b1) + reg * np.sum(b2*b2)
    #############################################################################
    #                              END OF YOUR CODE                             #
    #############################################################################
